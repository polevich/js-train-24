...
function task9() {
  ...
  fetchWithError()
    .then((data) => {
      console.log("Дані:", data); // Якщо проміс виконаний успішно виводимо в консоль дані які він повертає
    })
    .catch((error) => {
      console.error("Error:", error); // Якщо проміс виконаний з помилкою виводимо в консоль помилку
    });
}
